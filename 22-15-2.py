...
# Implementamos el método de Romberg con impresión de iteraciones y criterio de detección del 0.5%
def romberg(a, b, n, tol=0.005):
...
resultado = romberg(0, 16, 4, tol=0.005)
